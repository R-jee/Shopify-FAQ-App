        ...
        <div class="row">
            ...
            <style>
                .accordion {
                    ...
                    --bs-accordion-btn-focus-box-shadow: 0 0 0 .25rem {{ $configuration->accordion_item_question_focus_color }}30;
...
<style>
    ...
    .accordion-item:not(.collapsed){
        border-start-start-radius: {{ $configuration->accordion_item_question_border_radius_after_topleft }}px !important;
        border-start-end-radius: {{ $configuration->accordion_item_question_border_radius_after_topright }}px !important;
        border-end-start-radius: {{ $configuration->accordion_item_question_border_radius_after_bottomleft }}px !important;
        border-end-end-radius: {{ $configuration->accordion_item_question_border_radius_after_bottomright }}px !important;
    }
    .accordion-collapse{
        border-color: {{ $configuration->accordion_item_question_border_active_color }};
        border-top: 0px solid {{ $configuration->accordion_item_question_border_active_color }};
        border-bottom: {{ $configuration->accordion_item_question_border_bottom }}px solid {{ $configuration->accordion_item_question_border_active_color }};
        border-left: {{ $configuration->accordion_item_question_border_left }}px solid {{ $configuration->accordion_item_question_border_active_color }};
        border-right: {{ $configuration->accordion_item_question_border_right }}px solid {{ $configuration->accordion_item_question_border_active_color }};
        border-end-start-radius: {{ $configuration->accordion_item_question_border_radius_after_bottomleft }}px !important;
        border-end-end-radius: {{ $configuration->accordion_item_question_border_radius_after_bottomright }}px !important;
    }
...
@section('scripts')
  ...
  <script>
    ...
    $(".accordion-item:first-of-type .accordion-button.collapsed").css("border-end-end-radius", "{{ $configuration->accordion_item_question_border_radius_bottomright }}px");
		...
		$(".accordion-item:last-of-type").css("border-start-start-radius", "{{ $configuration->accordion_item_question_border_radius_topleft + 3 }}px");
		$(".accordion-item:last-of-type").css("border-start-end-radius", "{{ $configuration->accordion_item_question_border_radius_topright + 3 }}px");
		$(".accordion-item:last-of-type").css("border-end-start-radius", "{{ $configuration->accordion_item_question_border_radius_bottomleft + 3 }}px");
		$(".accordion-item:last-of-type").css("border-end-end-radius", "{{ $configuration->accordion_item_question_border_radius_bottomright + 3 }}px");
		$(".accordion-item:last-of-type .accordion-button.collapsed").css("border-start-start-radius", "{{ $configuration->accordion_item_question_border_radius_topleft }}px");
    $(".accordion-item:last-of-type .accordion-button.collapsed").css("border-start-end-radius", "{{ $configuration->accordion_item_question_border_radius_topright }}px");
    $(".accordion-item:last-of-type .accordion-button.collapsed").css("border-end-start-radius", "{{ $configuration->accordion_item_question_border_radius_bottomleft }}px");
    $(".accordion-item:last-of-type .accordion-button.collapsed").css("border-end-end-radius", "{{ $configuration->accordion_item_question_border_radius_bottomright }}px");

		$("#accordion_item_question_focus_color").on('input', function(e){
      $(".accordion").css("--bs-accordion-btn-focus-box-shadow", "0 0 0 .25rem "+ $(this).val() +"30");
    });
    ...
    function(e){
        ...
        $(".accordion-item:last-of-type").css("border-start-start-radius", parseInt($("#accordion_item_question_border_radius_topleft").val()) +3);
        $(".accordion-item:last-of-type").css("border-start-end-radius", parseInt($("#accordion_item_question_border_radius_topright").val()) +3);
        $(".accordion-item:last-of-type").css("border-end-start-radius", parseInt($("#accordion_item_question_border_radius_bottomleft").val()) +3);
        $(".accordion-item:last-of-type").css("border-end-end-radius", parseInt($("#accordion_item_question_border_radius_bottomright").val()) +3);

        $(".accordion-item:last-of-type .accordion-button.collapsed").css("border-start-start-radius", $("#accordion_item_question_border_radius_topleft").val() +"px");
        $(".accordion-item:last-of-type .accordion-button.collapsed").css("border-start-end-radius", $("#accordion_item_question_border_radius_topright").val() +"px");
        $(".accordion-item:last-of-type .accordion-button.collapsed").css("border-end-start-radius", $("#accordion_item_question_border_radius_bottomleft").val() +"px");
        $(".accordion-item:last-of-type .accordion-button.collapsed").css("border-end-end-radius", $("#accordion_item_question_border_radius_bottomright").val() +"px");
    });

  </script>0.

  <script>
		$(".accordion-button:not(.collapsed)").css("border-color", "{{ $configuration->accordion_item_question_border_active_color }} !important");
		$(".accordion-button:not(.collapsed)").css("border-top", "{{ $configuration->accordion_item_question_border_top }}px solid {{ $configuration->accordion_item_question_border_active_color }}");
		$(".accordion-button:not(.collapsed)").css("border-bottom", "0px solid {{ $configuration->accordion_item_question_border_active_color }}");
		$(".accordion-button:not(.collapsed)").css("border-left", "{{ $configuration->accordion_item_question_border_left }}px solid {{ $configuration->accordion_item_question_border_active_color }}");
		$(".accordion-button:not(.collapsed)").css("border-right", "{{ $configuration->accordion_item_question_border_right }}px solid {{ $configuration->accordion_item_question_border_active_color }}");
		$(".accordion-button:not(.collapsed)").css("border-start-start-radius", "{{ $configuration->accordion_item_question_border_radius_after_topleft }}px !important");
		$(".accordion-button:not(.collapsed)").css("border-start-end-radius", "{{ $configuration->accordion_item_question_border_radius_after_topright }}px !important");
		$(".accordion-button:not(.collapsed)").css("border-end-start-radius", "0px !important");
		$(".accordion-button:not(.collapsed)").css("border-end-end-radius", "0px !important");
		...
		$("#accordion_item_question_border_active_color," +
			...
			"#accordion_item_question_border_radius_after_bottomright").on('input',
    function(e){
      $(".accordion-button:not(.collapsed)").css("border-color", $("#accordion_item_question_border_active_color").val() +" !important");
      $(".accordion-button:not(.collapsed)").css("border-top", $("#accordion_item_question_border_top").val() +"px solid "+ $("#accordion_item_question_border_active_color").val());
      $(".accordion-button:not(.collapsed)").css("border-bottom", "0px solid " +$("#accordion_item_question_border_active_color").val());
      $(".accordion-button:not(.collapsed)").css("border-left", $("#accordion_item_question_border_left").val() +"px solid "+ $("#accordion_item_question_border_active_color").val());
      $(".accordion-button:not(.collapsed)").css("border-right", $("#accordion_item_question_border_right").val() +"px solid "+ $("#accordion_item_question_border_active_color").val());
      $(".accordion-button:not(.collapsed)").css("border-start-start-radius", $("#accordion_item_question_border_radius_after_topleft").val() +"px !important");
      $(".accordion-button:not(.collapsed)").css("border-start-end-radius", $("#accordion_item_question_border_radius_after_topright").val() +"px !important");
      $(".accordion-button:not(.collapsed)").css("border-end-start-radius", "0px !important");
      $(".accordion-button:not(.collapsed)").css("border-end-end-radius", "0px !important");

      $(".accordion-item:not(.collapsed)").css("border-start-start-radius", $("#accordion_item_question_border_radius_after_topleft").val() +"px !important;");
      $(".accordion-item:not(.collapsed)").css("border-start-end-radius", $("#accordion_item_question_border_radius_after_topright").val() +"px !important;");
      $(".accordion-item:not(.collapsed)").css("border-end-start-radius", $("#accordion_item_question_border_radius_after_bottomleft").val() +"px !important;");
      $(".accordion-item:not(.collapsed)").css("border-end-end-radius", $("#accordion_item_question_border_radius_after_bottomright").val() +"px !important;");

      $(".accordion-collapse").css("border-color", $("#accordion_item_question_border_active_color").val() +" !important");
      $(".accordion-collapse").css("border-top", "0px solid "+ $("#accordion_item_question_border_active_color").val() );
      $(".accordion-collapse").css("border-bottom", $("#accordion_item_question_border_bottom").val() +"px solid "+$("#accordion_item_question_border_active_color").val() );
      $(".accordion-collapse").css("border-left", $("#accordion_item_question_border_left").val() +"px solid "+$("#accordion_item_question_border_active_color").val() );
      $(".accordion-collapse").css("border-right", $("#accordion_item_question_border_right").val() +"px solid "+$("#accordion_item_question_border_active_color").val() );
      $(".accordion-collapse").css("border-end-start-radius",  $("#accordion_item_question_border_radius_after_bottomleft").val()+" !important");
      $(".accordion-collapse").css("border-end-end-radius",  $("#accordion_item_question_border_radius_after_bottomright").val()+" !important");
    });

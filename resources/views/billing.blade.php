...
@section('content')
    ...
    <div class="page-heading">
        ...
        <ol class="breadcrumb">
            <li class="breadcrumb-item">
                <a href="{{ route('plans', [ 'shop' => $shop]) }}"><i class="fa fa-gear"></i></a>
            </li>
            <li class="breadcrumb-item">Billing Plans</li>
        </ol>
    </div>
    ...
    <div class="bg-white dark:bg-gray-900 py-8 my-4">
                ...
                <div class="flex-1 xl:mx-8">
                    <div class="mt-8 space-y-8 md:-mx-4 md:flex md:items-center md:justify-center md:space-y-0 xl:mt-0">
                        ...
                        <div class="max-w-sm mx-auto border rounded-lg md:mx-4 dark:border-gray-700">
                            <div class="p-6">
                                <h1 class="text-xl font-medium text-gray-700 capitalize lg:text-3xl dark:text-white">Basic Free Plan</h1>
                                <p class="mt-4 text-gray-500 dark:text-gray-300">Free Plan</p>
                                <h2 class="mt-4 text-2xl font-medium text-gray-700 sm:text-4xl dark:text-gray-300">Free <span class="text-base font-medium">/Month</span></h2>
                                <p class="mt-1 text-gray-500 dark:text-gray-300">Payment Free</p>
                                <button class="w-full px-4 py-2 mt-6 tracking-wide text-white capitalize transition-colors duration-200 transform bg-blue-600 rounded-md hover:bg-blue-500 focus:outline-none focus:bg-blue-500 focus:ring focus:ring-blue-300 focus:ring-opacity-80"><a href="{{ route('free.plan', [ 'shop' => auth()->user()->name]) }}">Start Now</a></button>
                            </div>
                        ...
                        <div class="max-w-sm mx-auto border rounded-lg md:mx-4 dark:border-gray-700">
                            <div class="p-6">
                                <h1 class="text-xl font-medium text-gray-700 capitalize lg:text-3xl dark:text-white">{{ $plans[0]->name }}</h1>
                                <p class="mt-4 text-gray-500 dark:text-gray-300">{{ $plans[0]->terms }}</p>
                                <h2 class="mt-4 text-2xl font-medium text-gray-700 sm:text-4xl dark:text-gray-300">${{ $plans[0]->price }} <span class="text-base font-medium">/Month</span></h2>
                                <p class="mt-1 text-gray-500 dark:text-gray-300">{{ $plans[0]->interval }}</p>
                                <button class="w-full px-4 py-2 mt-6 tracking-wide text-white capitalize transition-colors duration-200 transform bg-blue-600 rounded-md hover:bg-blue-500 focus:outline-none focus:bg-blue-500 focus:ring focus:ring-blue-300 focus:ring-opacity-80"><a href="{{ route('billing', ['plan' => $plans[0]->id, 'shop' => auth()->user()->name ]) }}">Start Now</a></button>
                            </div>
                            <hr class="border-gray-200 dark:border-gray-700">
                            <div class="p-6">
                                <h1 class="text-lg font-medium text-gray-700 capitalize lg:text-xl dark:text-white">What’s included:</h1>
                        ...
                        <div class="max-w-sm mx-auto border rounded-lg md:mx-4 dark:border-gray-700">
                            <div class="p-6">
                                <h1 class="text-xl font-medium text-gray-700 capitalize lg:text-3xl dark:text-white">{{ $plans[1]->name }}</h1>
                                <p class="mt-4 text-gray-500 dark:text-gray-300">
                                    {{ $plans[1]->terms }}
                                </p>
                                <h2 class="mt-4 text-2xl font-medium text-gray-700 sm:text-4xl dark:text-gray-300">${{ $plans[1]->price }} <span class="text-base font-medium">/Monthly</span></h2>
                                ...
                                <button class="w-full px-4 py-2 mt-6 tracking-wide text-white capitalize transition-colors duration-200 transform bg-blue-600 rounded-md hover:bg-blue-500 focus:outline-none focus:bg-blue-500 focus:ring focus:ring-blue-300 focus:ring-opacity-80">
                                    <a href="{{ route('billing', ['plan' => $plans[1]->id, 'shop' => $shop ]) }}">Start Now</a>
                                </button>
                            </div>
                            <hr class="border-gray-200 dark:border-gray-700">
                            <div class="p-6">
